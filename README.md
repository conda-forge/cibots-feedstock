About cibots-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cibots-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2809&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cibots-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cibots` can be installed with `conda`:
...
```
mamba install cibots
```

It is possible to list all of the versions of `cibots` available on your platform with `conda`:
...
```
mamba search cibots --channel conda-forge
```
...
mamba repoquery search cibots --channel conda-forge

# List packages depending on `cibots`:
mamba repoquery whoneeds cibots --channel conda-forge

# List dependencies of `cibots`:
mamba repoquery depends cibots --channel conda-forge
```
